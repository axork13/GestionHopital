...
{
    public class Hospitalisation : BaseDTO
    {
        ...
        public Hospitalisation(int id_admission, DateTime date_admission, string type_admission, string motif_admission, string medecin_traitant, string nom_accompagnant, string prenom_accompagnant, string lien_parente, DateTime date_entreeAcc, DateTime date_sortieAcc, DateTime date_sortie, string motif_sortie, string resultat_sortie, DateTime date_deces, string motif_deces, int patient_id, int traitement_id, int facture_id)
        {
        ...
        {
            return (date_admission == null || type_admission == "" || type_admission == null || motif_admission == "") ? false : true;
        }
        ...
        public override string ToString()
        {
            return "Hospitalisation (id:" + id_admission + ", date admission:" + date_admission + ", type:" + type_admission + ", motif:" + motif_admission +
                ...
                "\ndate deces:" + date_deces + ",motif deces:" + motif_deces + ")";
        }
    }
}
